...
{
    public partial class ModifStationCarburant : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<Guid>(
                name: "StationServiceIdSt",
                table: "Carburants",
                type: "uniqueidentifier",
                nullable: true);

            migrationBuilder.CreateIndex(
                name: "IX_Carburants_StationServiceIdSt",
                table: "Carburants",
                column: "StationServiceIdSt");

            migrationBuilder.AddForeignKey(
                name: "FK_Carburants_StationServices_StationServiceIdSt",
                table: "Carburants",
                column: "StationServiceIdSt",
